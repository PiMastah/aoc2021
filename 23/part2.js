...
const rooms = [
  [types[input[3][3]],types.D, types.D, types[input[2][3]]],
  [types[input[3][5]],types.B, types.C, types[input[2][5]]],
  [types[input[3][7]],types.A, types.B, types[input[2][7]]],
  [types[input[3][9]],types.C, types.A, types[input[2][9]]]
]
